...
namespace ERPProject
{
    ...
    public partial class Form2 : Form
    {
        ...
        private void button38_Click(object sender, EventArgs e)
        {
            ...
            //textSave123(textBox138.Text, textBox145.Text);
            textSave1234("비밀번호",textBox138.Text,textBox145.Text);
        ...
        private void textSave123(string a, string b)//아이디 비번 텍스트 생성 함수
        {
        ...
        private void textSave1234(string a, string b,string c)//아이디 비번 텍스트 생성 함수
        {
            StreamWriter writer_;
