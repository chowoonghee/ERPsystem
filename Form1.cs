...
namespace ERPProject
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void personal() //아이디 비번 확인 함수
        {
            ...
            FileInfo dp01 = new FileInfo(dtif + "\\직원관리" + "\\" + "비밀번호" + "\\" + textBox1.Text + ".txt");
            string dp001 = dtif + "\\직원관리" + "\\" + "비밀번호" + "\\" + textBox1.Text + ".txt";
            ...
            try
            {
                if (dp11.Exists)
                {
                    ...
                    if (splitData[3] == "인사팀")
                    {
                        if (textBox2.Text == splitId[1] && textBox1.Text == splitId[0])
                        {
                            ...
                            //setting1.SetText(textBox1.Text);
                            master.Show();
                ...
                else if (dp12.Exists)
                {
                    ...
                    if (splitData[3] == "재무팀")
                    {
                        //MessageBox.Show("재무팀 잘읽음");

                        if (textBox2.Text == splitId[1] && textBox1.Text == splitId[0])
                        {

                            //MessageBox.Show("아디비번은>");
                            this.Visible = false;
        ...
        private void textSave(string a,string b)
        {
            StreamWriter writer_;

            FileInfo dp = new FileInfo(dtif + "\\직원관리" + "\\" + a + "\\");

            string strFilePath = dp + b + ".txt"; // 저장할위치 + 저장할 텍스트이름
        ...
        private void textSave1() //공지사항 텍스트파일 생성 함수
        {
            ...
            writer_ = File.CreateText(strFilePath);
            writer_.Write(DateTime.Now.ToString("yyyy-MM-dd"));
            writer_.Close();
            writer_.Dispose();
        }
